...
| [0004](adr/0004-portable-storage-paths.md) | Portable storage paths | Proposed | Storage paths are env-overridable with project-root defaults; DBs persist basenames, never absolute paths. |
