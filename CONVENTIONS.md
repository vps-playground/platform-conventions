...
| [0005](adr/0005-coolify-resource-configuration.md) | Coolify resource configuration recipe | Proposed | GitHub App source, Docker Compose build pack, namespaced `<app>-data` volume at `/data`, env vars in Coolify UI, auto-deploy on `main`. |
