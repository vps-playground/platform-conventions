...
| [0008](adr/0008-scheduled-jobs-coolify.md) | Scheduled jobs via Coolify Scheduled Tasks | Proposed | App-level scheduled jobs are Coolify Scheduled Tasks attached to the resource, not host crontab. |
